          ...
          <div class="col-lg-12 entries">
            ...
            <div id="comm_list">
              ...
              <div class="entry-content">
                ...
                <div class="read-more">
                  <a href="<%=application.getContextPath() %>/community/comm_detail">Read More</a>
                </div>
              </div>
            ...
            <article class="entry">
              ...
              <div  style="display:inline-block; padding-bottom: 3%; padding-right: 3%;">
                <img src="assets/img/blog-2.jpg"  style="border-radius:20px; width: 120px; height:120px">
              </div>
            ...
            <article class="entry">
              ...
              <div  style="display:inline-block; padding-bottom: 3%; padding-right: 3%;">
                <img src="assets/img/blog-3.jpg"  style="border-radius:20px; width: 120px; height:120px">
              </div>
            ...
            <article class="entry">
              ...
              <div  style="display:inline-block; padding-bottom: 3%; padding-right: 3%;">
                <img src="<%=application.getContextPath() %>/resources/assets/img/blog-4.jpg"  style="border-radius:20px; width: 120px; height:120px">
              </div>
